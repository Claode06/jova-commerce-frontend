        ...
        <form @submit.prevent="handleUpdate" class="space-y-5">
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.name" type="text" placeholder="Nama Anda" class="w-full px-4 py-3.5 border border-gray-200 rounded-2xl text-sm focus:border-accent-400 focus:outline-none transition-colors pl-11" required />
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.email" type="email" placeholder="nama@email.com" class="w-full px-4 py-3.5 border border-gray-200 rounded-2xl text-sm focus:border-accent-400 focus:outline-none transition-colors pl-11" required />
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.phone" type="tel" placeholder="081234567890" class="w-full px-4 py-3.5 border border-gray-200 rounded-2xl text-sm focus:border-accent-400 focus:outline-none transition-colors pl-11" required />
            </div>
          </div>
          ...
          <button type="submit" class="w-full py-3.5 bg-black text-white text-sm font-medium rounded-full hover:bg-accent-400 transition-colors disabled:opacity-50" :disabled="updating">
